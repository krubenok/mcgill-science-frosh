        ...
        <section className="container mx-auto px-4 my-20 pt-8 space-y-4">
          ...
          <Accordion allowZeroExpanded>
            ...
            <AccordionItem>
              ...
              <AccordionItemPanel>
                <p className="text-m lg:text-l mt-2 font-light">
                  Register <a href="https://mcgill-orientation-week.eventus.io/login">here</a>.Your
                  Frosh swag will be mailed directly to your house just in time for frosh. We
                  strongly encourage you to register early as spots fill up quickly! Remember that
                  your spot is not guaranteed until your payment has been processed so please be
                  sure to check your emails for when payment opens.
                </p>
              </AccordionItemPanel>
            </AccordionItem>
            <AccordionItem>
